        ...
        for (var key in data) {
            ...
            switch (key) {
                case "load":
                    ...
                    for (var iCube_1 = _level.cubes.length; iCube_1--;) {
                        var cube_1 = _level.cubes[iCube_1];
                        cube_1.center.__proto__ = Vec3.prototype;
                        for (var iSide = cube_1.rgSides.length; iSide--;) {
                            var side = cube_1.rgSides[iSide];
                            side.cubeIndex = {
                                iCube: iCube_1,
                                iSide: iSide,
                            };
...
function getVisibleNeighbors(root) {
    var rgVisible = [];
...
//# sourceMappingURL=Visibility_worker.js.map
